...
public class UserViewFactory {
    ...
    public UserView create(User user) {
        var image = user.imageName() != null ? thumbnailServerUrl + '/' + user.imageName() : thumbnailServerUrl + '/' + defaultThumbnail;
    ...
    public DeveloperView createDeveloper(User user) {
        var image = user.imageNameSmall() != null ? thumbnailServerUrl + '/' + user.imageNameSmall() : thumbnailServerUrl + '/' + defaultThumbnail;
